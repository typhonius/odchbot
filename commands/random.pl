...
#2# Description: This command splurges out a random sentence!
...
my $noun2 = $nouns[int(rand($#nouns))];
my $verb = $verbs[int(rand($#verbs))];
my $preposition = $prepositions[int(rand($#prepositions))];
my $adverb = $adverbs[int(rand($#adverbs))];
my $adjective = $adjectives[int(rand($#adjectives))];
my $message = "The $adjective $noun $verb $adverb $preposition the $noun2";
